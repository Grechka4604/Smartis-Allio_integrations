...
| `integration_id` | int | id интеграции в нашей БД |
| `raw_json` | string | request от веб хуки |
| `is_processed` | int | статус обработки веб хука|
| `created_at` | timestamp | Время получения вебхука |
| `update_at` | timestamp | Время обновления вебхука |
